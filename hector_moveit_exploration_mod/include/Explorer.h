...
class Quadrotor{
    private:
        ...
        const double takeoff_altitude = 4.0;
        const double landing_altitude = 0.2;
        int GRID;
        ...
        void gotocenter(const std::vector<double> &p1, const std::vector<double> &p2, const std::vector<double> &p3, const std::vector<double> &p4);
        std::vector<std::vector<double>> findtree();
        std::vector<std::vector<double>> computewaypoint(const std::vector<std::vector<double>> &treematrix);
